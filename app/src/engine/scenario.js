...
export const SCENARIOS = [
  {
    ...
    review: { focus: ['收益 vs 沪深300', '换手率与摩擦成本', '教学卡：牛市里最贵的错觉——以为赚钱是因为自己聪明'] },
  },
  {
    ...
    review: { focus: ['最大回撤对比', '行为记录：你在最低点附近做了什么', '教学卡：恐慌中卖出的每一分钱，都是别人捡走的便宜筹码'] },
  },
  {
    ...
    review: { focus: ['定投 vs 一次性对比', '横盘期操作频率', '教学卡：没事别打开账户'] },
  },
  {
    ...
    review: { focus: ['组合 vs 只持有A股', '黄金的"背叛"', '教学卡：分散不是永远不亏，是让"亏"变得可以承受'] },
  },
  {
    ...
    review: { focus: ['四项行为判定（顶部/底部/杠杆内幕/换手率）', '毕业证书'] },
  },
]
